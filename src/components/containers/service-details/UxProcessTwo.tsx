          ...
          <div className="col-12">
            <div className="service-f-wrapper">
              ...
              <div
                className={
                  "service-f-single fade-top " +
                  (imgTab == 9 ? " service-f-single-active" : " ")
                }
              >
                <div className="single-item">
                  <div className="intro-btn">
                    <h4>Product Optimization & A/B Testing</h4>
                  </div>
                </div>
                <div className="single-item p-single p-sm body-cn">
                  <p>
                  We optimize your product’s performance through data-driven insights and strategic A/B testing, ensuring a seamless user experience.
                  </p>
                </div>
                <button
                  className="toggle-service-f"
